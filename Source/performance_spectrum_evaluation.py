...
def plot_ps_separate_ax(yt, LG, axi, ci=None, title='', cutoff=None, plotquartiles=[True,True,True,True]):
...
for i,c in zip([0,1,4,5],crops):
    ...
    plot_ps_separate_ax(yt, cp_log, i, ci, c, 'usual_harvest_end',historical_quartiles)
    ci+=1

pt_log=pm4py.filtering.filter_event_attribute_values(flt_log, 'Crop', crops,retain=False)
plot_ps_separate_ax(yt, pt_log, -3, None , 'Other crops', 250,historical_quartiles)
